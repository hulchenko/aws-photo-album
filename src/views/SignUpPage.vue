<template>
  <div>
    ...
    >
      ...
      <div class="flex flex-col mt-2">
        <label class="block text-gray-900 text-sm font-bold" for="email"
          >Email</label
        >
        <input
          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 mb-7 leading-tight focus:outline-none focus:shadow-outline"
          type="email"
          id="email"
          v-model="email"
        />
    ...
    <div v-if="confirmPassword" class="w-4/12 m-auto">
      ...
      <div class="flex flex-col mt-2">
        <label class="block text-gray-900 text-sm font-bold" for="password"
          >Code</label
        >
        <input
